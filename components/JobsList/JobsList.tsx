...
import { Sorting } from '@/components/JobsList/Sorting';
import { StatItem } from '@/components/JobsList/StatItem';
import { JobCard } from '@/components/job-card/JobCard';
import { SearchFilter } from '@/components/SearchFilter';
import { useJobs } from '@/context/JobsContext';
import { SortBy, SortOrder, useSearchParams } from '@/hooks/query-state';
import { Status } from '@/lib/common/common';
