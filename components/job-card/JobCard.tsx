...
import { DeleteJob } from '@/components/job-card/DeleteJob';
import { JobDetail } from '@/components/job-card/Detail';
import { Duration } from '@/components/job-card/Duration';
import { isExpired } from '@/components/job-card/expired';
import { StatusBadge } from '@/components/StatusBadge';
import { formatDate, formatSeconds } from '@/functions/format';
